...
namespace StingyBot.Tfs
{
    ...
    public class MetadataProvider : ConnectedBase
    {
        ...
        {
            var mostLikelyProject = TfsKnownElements.GetMostLikelyProject(TfsKnownElements.KnownProjectReferences.First().Value.Name);
