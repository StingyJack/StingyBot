namespace StingyBot.SalesForce.Models
{
    ...
    public class Solution
    {
        ...
        {
            return
                "SELECT SystemModstamp, TimesUsed, LastViewedDate, LastReferencedDate, IsHtml, Id, IsDeleted, SolutionNumber, SolutionName, IsPublished, IsPublishedInPublicKb, Status, IsReviewed, SolutionNote, OwnerId, CreatedDate, CreatedById, LastModifiedDate, LastModifiedById FROM Solution";
        }
    }
    ...
    public class Product2
    {
        ...
        {
            return
                "SELECT Id, Name, ProductCode, Description, IsActive, CreatedDate, CreatedById, LastModifiedDate, LastModifiedById, SystemModstamp, Family, IsDeleted, LastViewedDate, LastReferencedDate FROM Product2";
        }
    }
    ...
    public class Goal
    {
        ...
        {
            return
                "SELECT CreatedById, LastModifiedDate, LastModifiedById, SystemModstamp, LastViewedDate, LastReferencedDate, Description, ImageUrl, DueDate, CompletionDate, StartDate, IsKeyCompanyGoal, Status, Progress, OrigGoalId__c, Id, OwnerId, IsDeleted, Name, CreatedDate FROM Goal";
        }
    }
    ...
    public class Asset
    {
        ...
        {
            return
                "SELECT Id, ContactId, AccountId, ParentId, RootAssetId, Product2Id, IsCompetitorProduct, CreatedDate, CreatedById, LastModifiedDate, LastModifiedById, SystemModstamp, IsDeleted, Name, SerialNumber, InstallDate, PurchaseDate, UsageEndDate, Status, Price, Quantity, Description, OwnerId, LastViewedDate, LastReferencedDate FROM Asset";
        }
    }

    public class z_FieldDescription__c
    {
        public string Id { get; set; }
        public string IsDeleted { get; set; }
        public string Name { get; set; }
    ...
    public class z_MetaDumpSetting__c
    {
        ...
        {
            return
                "SELECT Id, OwnerId, IsDeleted, Name, CreatedDate, CreatedById, LastModifiedDate, LastModifiedById, SystemModstamp, LastViewedDate, LastReferencedDate, name__c FROM z_MetaDumpSetting__c";
        }
    }

    public class z_SObjectDescription__c
    {
        public string Id { get; set; }
        public string OwnerId { get; set; }
        public string IsDeleted { get; set; }
    ...
    public class ObiWan__c
    {
        ...
        {
            return
                "SELECT Id, OwnerId, IsDeleted, Name, CreatedDate, CreatedById, LastModifiedDate, LastModifiedById, SystemModstamp, LastActivityDate, LastViewedDate, LastReferencedDate FROM ObiWan__c";
        }
    }
    ...
    public class z_SchemaTemp__c
    {
        ...
        {
            return
                "SELECT Id, OwnerId, IsDeleted, Name, CreatedDate, CreatedById, LastModifiedDate, LastModifiedById, SystemModstamp, fieldname__c, objid__c, objname__c FROM z_SchemaTemp__c";
        }
    }

    public class z_ChildRelationship__c
    {
        public string Id { get; set; }
        public string IsDeleted { get; set; }
        public string Name { get; set; }
        ...
        {
            return
                "SELECT Id, IsDeleted, Name, CreatedDate, CreatedById, LastModifiedDate, LastModifiedById, SystemModstamp, z_ParentSObjectDescription__c, childobjectname__c, fieldname__c, isCascadeDelete__c, z_ChildSObjectDescription__c FROM z_ChildRelationship__c";
        }
    }
    ...
    public class Pricebook2
    {
        ...
        {
            return
                "SELECT Id, IsDeleted, Name, CreatedDate, CreatedById, LastModifiedDate, LastModifiedById, SystemModstamp, LastViewedDate, LastReferencedDate, IsActive, Description, IsStandard FROM Pricebook2";
        }
    }
    ...
    public class PricebookEntry
    {
        ...
        {
            return
                "SELECT Id, Name, Pricebook2Id, Product2Id, UnitPrice, IsActive, UseStandardPrice, CreatedDate, CreatedById, LastModifiedDate, LastModifiedById, SystemModstamp, ProductCode, IsDeleted FROM PricebookEntry";
        }
    }
}